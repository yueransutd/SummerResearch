...
if __name__ == "__main__":
    ...
    parser.add_argument('--load_arg', default='./checkpoint/ner/ner_lstm_crf.json', help='path to arg json')
    parser.add_argument('--load_check_point', default='./checkpoint/ner_lstm_crf.model', help='path to model checkpoint file')
    ...
    #save_transition
    #torch.save(str(ner_model.save_transition()), "output_w.txt")
...
{'O': 1, 'I-MISC': 2, '<pad>': 9, 'I-ORG': 0, 'I-PER': 3, 
'<start>': 8, 'B-LOC': 5, 'B-ORG': 7, 'I-LOC': 4, 'B-MISC': 6}
